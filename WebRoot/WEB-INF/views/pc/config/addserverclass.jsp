			...
			$.ajax({
				...
				success : function(result) {
					if (result.retCode == 'success') {
						...
						parent.layui.table.reload('serverclassInfo');
...
<body>
	<form class="layui-form" action="" id="form"
		...
		<input type="hidden" name="id" id="id" value="${serveClass.id }" />
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="text" name="className" lay-verify="required"
					...
					value="${serveClass.className }">
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">备注</label>
			<div class="layui-input-block">
				<textarea name="remark" class="layui-textarea">${serveClass.remark }</textarea>
			</div>
		</div>
		<div class="layui-form-item">
