...
<body>
	<form class="layui-form" action="" id="form" style="width: 95%;height: 98%;margin-top: 1%;" lay-filter="addform">
		...
		<div class="layui-form-item">
			<label class="layui-form-label">应付总计</label>
			<div class="layui-input-block">
				<input type="number" name="payAmount" id="payAmount" autocomplete="off" class="layui-input layui-disabled" value="0.00" disabled="disabled"/>
			</div>
		</div>
	</form>
</body>
