			...
			$.ajax({
				...
				success : function(result) {
					if (result.retCode == 'success') {
						...
						parent.layui.table.reload('roleInfo');
...
<%--		</div>--%>
		<div class="layui-form-item">
			...
			<div class="layui-input-block">
				<input type="checkbox" name="enable" lay-skin="switch"
					lay-text="启用|禁用"
					<c:if test="${sysRole.enable=='1' or empty sysRole}">checked</c:if>
					value="1" />
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="description" placeholder="请输入备注"
					class="layui-textarea">${sysRole.description }</textarea>
			</div>
		</div>
		<div class="layui-form-item">
