...
<body>
	<form class="layui-form" action="" id="form"  style="width: 95%;height: 98%;margin-top: 1%;">
		<input type="hidden" name="id" id="id" value="${couponPack.id }" />
		<div class="layui-form-item">
			<label class="layui-form-label">卷包名称</label>
			<div class="layui-input-block">
				<input type="text" name="name" required lay-verify="required"
					placeholder="请输入卷包名称" autocomplete="off" class="layui-input"
					value="${couponPack.name}">
			</div>
		</div>
		...
		<div class="layui-form-item layui-form-text">
			...
			<div class="layui-input-block">
				<textarea name="remark" placeholder="请输入描述"
					class="layui-textarea">${couponPack.remark}</textarea>
			</div>
		</div>
		<div class="layui-form-item">
