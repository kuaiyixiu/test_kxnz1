...
<body>
	<div class="page-content-wrap">
		<div class="layui-col-md12">
			...
			<div class="layui-card" style="margin-top: 1%;">
				<div class="layui-card-header">挂账订单列表</div>
				<div class="layui-card-body">
					<div class="layui-carousel layadmin-carousel layadmin-dataview" data-anim="fade" lay-filter="LAY-index-dataview" style="width: 100%;" lay-anim="fade" lay-indicator="inside" lay-arrow="none" id="">
						<div class="layui-form" id="">
							<table class="layui-table" id="orderCountDetail1" lay-filter="tableInfo"></table>
						</div>
					</div>
				</div>
			</div>
			<div class="layui-card" style="margin-top: 1%;">
				<div class="layui-card-header">入账订单列表</div>
				<div class="layui-card-body">
					<div class="layui-carousel layadmin-carousel layadmin-dataview" data-anim="fade" lay-filter="LAY-index-dataview" style="width: 100%;" lay-anim="fade" lay-indicator="inside" lay-arrow="none" id="">
						<div class="layui-form" id="">
							<table class="layui-table" id="orderCountDetail2" lay-filter="tableInfo"></table>
						</div>
					</div>
				</div>
			</div>
...
function userDefinedLoadGrd($, table, parentId, id) {
	...
	$.ajax({
		...
		url : "report/getOrderDetailInfo.do",
		data : {
		...
		success : function(result) {
			...
			if (result) {
				...
				layui.table.render({
					...
					data : result.reportList1
				});
				
				layui.table.render({
					elem: '#orderCountDetail1',
					limit: '9999',
					page : false,
					cols: [
						[{
...
function showDetail(data){
	layui.use('element', function(){
		...
		var id = orderFrmId;
		var url = 'orders/toUpdateOrder/'+data.id+'/4.do';
